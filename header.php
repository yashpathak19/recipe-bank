	...
	<body>
		<header>
			<div class="row">
				...
				<form class="form-inline col-md-5" id="searchbar">
				...
				<a class="navbar-brand col-sm-4" href="index.php"><img src="images/logo.png"></a>
			...
			<div class="row">
				...
				<div class="collapse navbar-collapse" id="navbarColor01">
					<ul class="navbar-nav mr-auto">
						...
						<li class="nav-item">
							<a class="nav-link" href="starters.php">Starters</a>
						</li>
						<li class="nav-item">
