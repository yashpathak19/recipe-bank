...
$max_id = $feedObj->custom('select max(id) from recipes');
...
if (isset($_POST['addrecipe'])) {
    if(!empty($_FILES["image"]["tmp_name"])) {
        ...
        $count = $feedObj->createRecipe($title, $ingredients, $preparation, $category, $newfilename, $userId, date("Y-m-d\TH:i:s", time()));
        if ($count) {
